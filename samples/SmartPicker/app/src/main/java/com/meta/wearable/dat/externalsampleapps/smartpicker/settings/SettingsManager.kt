...
package com.meta.wearable.dat.externalsampleapps.smartpicker.settings
...
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "smartpicker_settings")
